  ...
  return (
    <section className="h-[25rem] sm:h-[28rem] md:max-h-[50rem] xl:h-full md:h-full flex flex-col md:flex-row md:gap-[1rem] md:justify-between">
      <div className="w-full md:w-[50%] my-auto mx-auto flex flex-col justify-center items-center md:items-start md:items-left">
        ...
        <h2 id="Rye" className="px-[1px] text-center md:text-left md:leading-[3.5rem] lg:leading-[4.5rem] xxl:leading-[6.5rem] text-[30px] sm:text-[36px] md:text-[2.5rem] lg:text-[3rem] xl:text-[4rem] xxl:text-[6rem] font-bold text-gray-800 ">
          Learn new skills online with ease
        </h2>
        <p id="inter" className="px-[3px] text-gray-700 text-[15px] sm:text-[16px] md:text-[1rem] lg:text-[1.2rem] xl:text-[1.5rem] xxl:text-[2rem] text-center md:text-left  py-5 lg:py-10 leading-relaxed ">
          Discover a wide range of courses covering a variety of subjects,
          taught by expert instructors.
        </p>
        <div id="inter" className="flex space-x-4">
