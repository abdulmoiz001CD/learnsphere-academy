  ...
  return (
    <>
      <header className="h-[50px] md:h-[52px] lg:h-[92px] flex justify-between md:gap-[64px] items-center px-[24px] md:px-[64px] bg-[#F7F7F7] border-b-[1px] border-[black]">
        ...
        <div className="w-[18px] sm:w-[24px] md:hidden text-[16px] sm:text-[18px]  ">
          <FaBars />
        </div>
        ...
        <ul id="roboto-thin" className="hidden md:flex justify-between items-center md:gap-[16px] bg-white max-w-[910px] w-full  pl-[10px]">
          ...
          <li className="leading-[15px] md:leading-[24px] sm:text-[9px] lg:text-[13px] xl:text-[16px] xxl:text-[20px] border-b-[1px] border-b-transparent hover:border-b-black cursor-pointer">About Us</li>
          ...
          <div className="btnCon inline-flex gap-5 items-center ">
            <button className="h-[26px] md:h-[21px] lg:h-[35px] cursor-pointer rounded-[3px] lg:rounded-[5px] lg:pb-[4px] px-[10px] lg:px-[20px] text-[10px] lg:text-[16px] xxl:text-[19px] text-center lg:leading-[24px] border-[1px] border-[#000000]">Login</button>
            <button className="h-[26px] md:h-[21px]  lg:h-[35px] cursor-pointer rounded-[3px] lg:rounded-[5px] lg:pb-[4px] px-[10px] lg:px-[20px] text-[10px] lg:text-[16px] xxl:text-[19px] text-center  bg-black text-white">Sign Up</button>
          </div>
        </ul>
      </header>
    </>
