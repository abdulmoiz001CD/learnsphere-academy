...
function Logo() {
  return (
   ...
   <div className='md:h-[6rem] lg:h-[8rem]  xxl:h-[239.34px] flex flex-col md:flex-row  md:justify-between max-sm:justify-center  gap-[34px]  md:items-center bg-[#F7F7F7]  md:px-2'>
    ...
    <div className=''>
        <h3 id="Rye" className='inter max-w-[340px] w-full text-[24px] md:text-[15px] lg:text-[19px] xxl:text-[30px] pl-3 font-[700]  text-start pt-6 md:p-0'>Trusted by 2000+ companies worldwide.</h3>
    </div>
