...
<div className="max-w-[300px] md:max-w-[130.6px] h-[25px] flex gap-[8.02px] items-center">
  ...
  <div className="font-latin text-[29.07px] md:text-[25.07px] font-bold tracking-[7px] md:tracking-normal leading-[30.34px]">
    Ddsgnr
  </div>
</div>
          ...
          <div className="flex flex-col gap-3 items-center md:items-start">
            <h3 className="font-semibold mb-2 text-[25.07px] md:text-sm">Courses</h3>
          ...
          <div className="flex flex-col gap-3 items-center md:items-start">
            <h3 className="font-semibold mb-2 text-[25.07px] md:text-sm">Resources</h3>
          ...
          <div className="flex flex-col gap-3 items-center md:items-start mb-4">
            <h3 className="font-semibold text-sm mb-2 text-[25.07px] md:text-sm">About Us</h3>
